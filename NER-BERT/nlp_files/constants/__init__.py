...
TIMESTAMP: str = dt.now().strftime("%d_%m_%Y_%H_%M_%S")

ARTIFACTS_DIR = os.path.join("artifacts",TIMESTAMP)
LOGS_DIR = "logs"
LOGS_FILE_NAME = "ner.logs" 
MODELS_DIR = "models"
BEST_MODEL_DIR = "best_model" 

BUCKET_NAME = "ner-bert-023"
GCP_DATA_FILE_NAME = "archive_m.zip"
CSV_DATA_FILE_NAME = "ner_m.csv"
GCP_MODEL_NAME = "model.pt"

DATA_INGESTIONS_ARTIFACTS_DIR = "DataIngestionArtifacts" 
